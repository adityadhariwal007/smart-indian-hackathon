...
export const translations = {
  en: {
    ...
    heroSubheadline: 'Real-time triage intelligence, zero-wait outpatient queues, and instant emergency response — coordinating patients, doctors, and hospitals across Patiala into one seamless care network.',
  ...
  hi: {
    ...
    heroHeadlineLies: 'है',
    heroSubheadline: 'रीयल-टाइम ट्राइएज बुद्धिमत्ता, शून्य-प्रतीक्षा ओपीडी कतारें, और त्वरित आपातकालीन प्रतिक्रिया — पटियाला के मरीजों, डॉक्टरों और अस्पतालों को एक निर्बाध नेटवर्क में जोड़ना।',
