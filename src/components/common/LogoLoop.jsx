...
export const LogoLoop = memo(
  ({
    ...
    const updateDimensions = useCallback(() => {
      ...
      if (isVertical) {
        ...
        if (sequenceHeight > 0) {
          ...
          setCopyCount(prev => (prev === copiesNeeded ? prev : copiesNeeded));
        }
    ...
    // Safe ResizeObserver with stable refs and zero infinite loop triggers
    useEffect(() => {
      updateDimensions();
    ...
    }, [updateDimensions, gap, logoHeight, isVertical]);

    // Safe image loader: only attaches if actual HTML <img> elements are present
    useEffect(() => {
